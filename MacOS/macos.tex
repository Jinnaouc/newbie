...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\title{\vspace{-2em}MAC OS X系统安装教程\vspace{0.7em}}%大标题
\author{陶虹}%作者
...
\newpage
 \chead{\color{GREY}MAC OS X 系统安装教程}%页眉
...
\includegraphics[width=0.5\textwidth]{figures/tu212.png}
\caption{\small 运行结果}
\label{tu210}
\end{figure} 
...
\begin{figure}[!htb] %插图
\centering
\includegraphics[width=0.5\textwidth]{figures/tu213.png}
\includegraphics[width=0.5\textwidth]{figures/tu214.png}
\caption{\small 运行结果}
\label{tu213}
\end{figure} 
...
\begin{figure}[!htb] %插图
\centering
\includegraphics[width=0.5\textwidth]{figures/tu215.png}
\includegraphics[width=0.5\textwidth]{figures/tu216.png}
\includegraphics[width=0.5\textwidth]{figures/tu217.png}
\caption{\small 运行结果}
\label{tu215}
\end{figure} 
...
\begin{figure}[!htb] %插图
\centering
\includegraphics[width=0.8\textwidth]{figures/tu218.png}
\includegraphics[width=0.6\textwidth]{figures/tu219.png}
\caption{\small 运行结果}
\label{tu218}
\end{figure} 
\end{enumerate}
